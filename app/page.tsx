      ...
      >
        <div className="w-full max-w-[1080px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
          ...
          <nav className="flex flex-col gap-4">
            {["About", "Membership", "Journal", "Sovereign Intelligence", "Application"].map((link) => (
              <a
                ...
                style={{ fontFamily: "var(--font-mono), 'Courier New', monospace", color: "var(--color-slate)", fontSize: "11px", letterSpacing: "0.08em", textTransform: "uppercase", textDecoration: "none" }}
              >
                {link}
              </a>
            ))}
          ...
          <div className="flex flex-col justify-between gap-8" style={{ minWidth: "280px" }}>
            ...
            <p style={{ fontFamily: "var(--font-mono), 'Courier New', monospace", color: "rgba(92, 100, 112, 0.40)", fontSize: "10px", letterSpacing: "0.04em", whiteSpace: "nowrap" }}>
