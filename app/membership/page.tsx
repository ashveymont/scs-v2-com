              ...
              <div>
                ...
                {[
                  ...
                  >
                    ...
                    <p className="mt-1" style={{ ...sans, fontSize: "14px", color: "rgba(245,242,236,0.4)", lineHeight: 1.7 }}>
                      {row.body}
                    </p>
                  </div>
                ))}
          ...
          <div className="w-full max-w-[1080px] mx-auto">
            ...
            <div className="mt-12">
              {[
                ...
                <div
                  key={standard.n}
                  className="grid grid-cols-1 md:grid-cols-[3fr_7fr] gap-8 md:gap-16 pt-12 pb-12"
      ...
      <RevealSection>
        ...
        >
          <div className="w-full max-w-[640px] mx-auto flex flex-col items-center">
            ...
            >
              Founding membership is limited. The Society is currently accepting applications for the Dubai founding cohort.
            </p>
